...
export class Menu {
  ...
  static async MenuPrincipal(): Promise<Opt> {
    const opciones: Colection = {
      ...
      choices: [
        Menu.createNewMenuTarea("1", `${"1.".green} Crear tarea`),
        Menu.createNewMenuTarea("2", `${"2.".green} Listar tareas`),
        Menu.createNewMenuTarea("3", `${"3.".green} Listar tareas completadas`),
        Menu.createNewMenuTarea("4", `${"4.".green} Listar tareas pendientes`),
        Menu.createNewMenuTarea("5", `${"5.".green} Completar tarea(s)`),
        Menu.createNewMenuTarea("6", `${"6.".green} Borrar tarea`),
